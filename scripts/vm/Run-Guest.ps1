...
try {
  ...
  if($suite -ne 'e2e') { Invoke-WebRequest 'http://127.0.0.1:20128/v1/models' -UseBasicParsing -TimeoutSec 10 | Out-Null }
  ...
  # Windows PowerShell 5 maps native stderr to ErrorRecord; use the native exit code.
